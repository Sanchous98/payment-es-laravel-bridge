...
class PaymentProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->app->singleton(AccountContextDispatcher::class, fn(Application $app) => new AccountContextDispatcher(
            new QueueMessageDispatcher(
                $app->tagged('es_dispatchers'),
                $app[Dispatcher::class],
            )
        ));
        $this->app->singleton(MessageDispatcher::class, AccountContextDispatcher::class);
